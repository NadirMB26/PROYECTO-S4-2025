...
public class Login_user_type extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        DrPet.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Image/Canes3.png"))); // NOI18N
        jPanel1.add(DrPet);
        DrPet.setBounds(180, 350, 220, 90);

        Login_TextField.setBackground(new java.awt.Color(255, 255, 255));
        ...
        User_Type2.setText("Veterinario");
        jPanel1.add(User_Type2);
        User_Type2.setBounds(380, 260, 120, 30);
        ...
        User_Type3.setText("Receptionista");
        jPanel1.add(User_Type3);
        User_Type3.setBounds(570, 260, 140, 30);

        AdminBtn.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        AdminBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Image/gerente (1).png"))); // NOI18N
        ...
        AdminBtn.setBounds(210, 160, 70, 80);

        PharmacistBtn.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        PharmacistBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Image/veterinario (2) (1).png"))); // NOI18N
        ...
        PharmacistBtn.setBounds(400, 150, 90, 100);

        ReciptionistBtn.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ReciptionistBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Image/recepcionista (1) (1).png"))); // NOI18N
        ...
        ReciptionistBtn.setBounds(600, 160, 70, 80);
        ...
        User_Type.setBounds(190, 260, 100, 30);

        Back.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Image/Home2 (1).png"))); // NOI18N
    ...
    private void AdminBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AdminBtnMouseClicked
        Login_user_type loginAdmin = new Login_user_type();
